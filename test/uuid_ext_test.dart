...
void main() {
  group('matchers', () {
    ...
    test('isNotUuidWithPrefix()', () {
      expect(
          '44030040-ca6d-43a3-9fda-0d121401f268'.isUuidWithPrefix(), isFalse);
      ...
      expect('-s-44030040-CA6D-43A3-9FDA-0D121401F268', isNotUuidWithPrefix);
      expect(
          'session44030040-ca6d-43a3-9fda-0d121401f268', isNotUuidWithPrefix);
      expect(
          '44030040-ca6d-43a3-9fda-0d121401f268-session', isNotUuidWithPrefix);
      expect(
          '44030040-ca6d-43a3-9fda-0d121401f268session-', isNotUuidWithPrefix);
      expect(
          '44030040-ca6d-43a3-9fda-0d121401f268session', isNotUuidWithPrefix);
    });
    ...
    test('isNotUuidWithPrefix(p)', () {
      expect('44030040-ca6d-43a3-9fda-0d121401f268'.isUuidWithPrefix('p'),
          isFalse);
  ...
  group('bittenOf*', () {
    ...
    test('bittenOfUuid44 on String', () {
      ...
      expect('  44030040-ca6d-43a3-9fda-0d121401f268 '.bittenOfUuid44,
          '4403:f268');
