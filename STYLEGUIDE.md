...
This is a general style guide that shall govern over all `IdGen` repositories. The aim is
...
- You must always use relative imports for imports within the `IdGen` library
