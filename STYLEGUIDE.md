...
This is a general style guide that shall govern over all **IdGen** project. The aim is
...
- You must always use relative imports for imports within the `id_gen` library
